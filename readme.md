修改 config.js，将 const RETRY_LIMIT = 7 改为 const RETRY_LIMIT = 1000 ；const PAGE_SIZE = 1000 改为 const PAGE_SIZE = 500

修改 src/gd.js，将 EXCEED_LIMIT = EXCEED_LIMIT || 7 改为 EXCEED_LIMIT = 1000 ；添加 RETRY_LIMIT = 1000
